...
if ($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    upload('/etr/imagens/me/');

    $sql = "INSERT into me (nome,imagem) values ('$nome','$imagem')";
...
<div class="page-header">
  <h3>Cadastro de Missão Especial</h3>
</div>
<form method="post" name="formMP" id="formMP" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])."?pagina=me/insere";?>"  enctype="multipart/form-data">
    <div class="row">
      <div class="col-md-4">
