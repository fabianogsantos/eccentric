...
if ($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $sql = "INSERT into aeronave (prefixo, nome,nome_guerra,data_inicio,versao,flg_aeronave_primaria,cod_posto,cod_aeronave,tipo_aeronave,imagem_2,nome_arq,status,ktz_cruz,min_adic,auton_nm,capac_gls,nome_arq_fsx) values ('$prefixo','$nome','$nome_guerra',STR_TO_DATE('$data_inicio','%d/%m/%Y'),'$versao','$flg_aeronave_primaria',$cod_posto,$cod_aeronave,'$tipo_aeronave','$imagem_2','$nome_arq','$status',$kts_cruz,min_adic=$min_adic,auton_nm=$auton_nm,capac_gls=$capac_gls,nome_arq_fsx='$nome_arq_fsx')";
    $res = $con->query($sql);
...
<form method="post" name="form1" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])."?pagina=aeronaves/aeronave";?>">
  <div class="row">
    <div class="col-md-2">
      <div class="form-group">
        <label for="cod_aeronave">Código interno</label>
        <input class="form-control"  type="text" name="cod_aeronave">
      </div>
    </div>
    <div class="col-md-2">
      <div class="form-group">
  ...
  <div class="row">
    <div class="col-md-3">
      <div class="form-group">
        ...
        <input class="form-control"  type="text" name="data_inicio">
      </div>
    </div>
    <div class="col-md-1">
      <div class="form-group">
  ...
  <div class="row">
    <div class="col-md-4">
      <label for="imagem_2">Imagem atual</label>
      <br>
      <img src="<?php echo '../'.$dir_imagem_aeronaves.'/'.$row['imagem_1']; ?>">
    </div>
  </div>
  <br><br>
