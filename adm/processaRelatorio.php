...
switch ($acao){
	case 2:
		...
		$assunto = "Relat&oacute;rio de voo aprovado";
...
$msg = "<html><body><p>Prezado Cmte. ".$nome_guerra."</p>".$msg2.
	  	"<p>Dados do relat&oacute;rio:</p>
	  	<table align=\"center\">
    	<tr valign=\"baseline\">
      	<td width=\"193\" align=\"right\" nowrap style=\"font-weight: bold\">N&uacute;mero do relat&oacute;rio:</td>
      	<td colspan='3'>".$row_rsrelatorio['numero']."</td>
		</tr>
		<tr valign=\"baseline\">
		<td align=\"right\" nowrap style=\"font-weight: bold\">Callsign:</td>
		<td colspan=\"3\">".$row_rsrelatorio['callsign']."</td>
		</tr>
		<tr valign=\"baseline\">
		<td width=\"193\" align=\"right\" nowrap style=\"font-weight: bold\">Modo:</td>
		<td colspan='3'>".$row_rsrelatorio['modo']."</td>
		</tr>
		<tr valign=\"baseline\">
		<td nowrap align=\"right\" style=\"font-weight: bold\">Tipo do voo:</td>
		<td colspan=\"3\">".trataTipoVoo($row_rsrelatorio['tipo'])."</td>
		</tr>
		<tr valign=\"baseline\">
		<td nowrap align=\"right\" style=\"font-weight: bold\">N&uacute;mero do voo:</td>
		<td colspan=\"3\">".ansi2br($row_rsrelatorio['numero_voo'])."</td>
		</tr>
		<tr valign=\"baseline\">
		<td nowrap align=\"right\" style=\"font-weight: bold\">ICAO Origem:</td>
		<td width=\"192\">".$row_rsrelatorio['icao_origem']."</td>
		</tr>
		<tr valign=\"baseline\">
		<td nowrap align=\"right\" style=\"font-weight: bold\">ICAO Destino:</td>
		<td colspan=\"3\">".$row_rsrelatorio['icao_destino']."</td>
		</tr>
		<tr valign=\"baseline\">
		<td nowrap align=\"right\" style=\"font-weight: bold\">Data Partida:</td>
		<td colspan=\"3\">".ansi2br($row_rsrelatorio['data_partida'])."</td>
		</tr>
		<tr valign=\"baseline\">
		<td nowrap align=\"right\" style=\"font-weight: bold\">Tempo de Voo:</td>
		<td colspan=\"3\">".$row_rsrelatorio['tempo_voo']."</td>
		</tr>
		<tr valign=\"baseline\">
 ...
 if (mail($email, $assunto, $msg, $headers)){
 	echo "Email enviado para piloto.<br>";
 }
 else
 ...
 <br/>
 <hr>
 <p><a href="index.php?pagina=adm_relatorios&opcao=1">Voltar para Administra&ccedil;&atildeo de Relat&oacute;rios</a></p>