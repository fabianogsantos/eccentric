...
<?php
  	echo "<h3>Voos Fretados</h3>";
	
	echo "<br /><p align='justify'>Os Voos Fretados são realizados por pilotos graduados no posto mínimo de Comandante Regional. A distância em milhas náuticas entre a origem e o destino foi estabelecida por uma linha reta, o que define sua categoria: até 3.000nm - Terceira Classe; até 4.000nm - Segunda Classe; até 5.000nm - Primeira Classe, e acima de 5.000nm - VFLD (Voos Fretados de Longa Distância). A duração do voo leva em consideração a velocidade cruzeiro do Boeing 747-400 \"King of Birds\" (514 nós), aeronave específica para a realização desta categoria de voo. Maiores detalhes no Catálogo de Rotas.</p><br />";
	...
	$sql_rotas = "select n_seq,n_ida,n_volta,tempo,distancia,icao_origem,icao_destino,cidade_origem,cidade_destino from rotas where  tipo like 'vf%' order by n_ida";
